...
<head>
    ...
    <title>E-Matrimony | My Matches</title>
</head>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="card cd crdrow">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url(); ?>profile" name="form<?= $i ?>" method="post">
                                    <input name="login" value="View Full Profile" type="submit"
                                        class="btn btn-outline-dark frmlbl btnb">
