<nav class="navbar bg-primary bg-body-tertiary fixed-top dispnon">
    <div class="container-fluid">
        <h3 class="navbar-brand title">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-server"
                viewBox="0 0 16 16">
                <path
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?= base_url() . 'dash' ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() . 'sendint' ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() . 'recdint' ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() . 'matches' ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
